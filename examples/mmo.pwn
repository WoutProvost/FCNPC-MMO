/*
 * License:
 * See LICENSE.md included in the release download, or at https://github.com/WoutProvost/FCNPC-MMO/blob/master/LICENSE.md if not included.

 * Credits:
 * See CREDITS.md included in the release download, or at https://github.com/WoutProvost/FCNPC-MMO/blob/master/CREDITS.md if not included.

 * Changelog:
 * See CHANGELOG.md included in the release download, or at https://github.com/WoutProvost/FCNPC-MMO/blob/master/CHANGELOG.md if not included.

 * Documentation:
 * Every function, callback or define is extensively explained at https://github.com/WoutProvost/FCNPC-MMO/wiki and its various subsections.
*/
